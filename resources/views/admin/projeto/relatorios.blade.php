                    ...
                    <tr>
                        ...
                        <td>
                            <a class="modal-trigger tooltipped" data-position="top" data-delay="50"
                               ...
                               target="_blank" href="{{route('admin.projeto.relatorios.projeto-individual', $projeto->id)}}"><i
                ...
                @forelse ($categorias as $categoria)
                    <tr>
                        ...
                        <td>
                            <a class="modal-trigger tooltipped" data-position="top" data-delay="50"
                               data-tooltip="Gerar relatório"
                               target="_blank" href="{{route('admin.projeto.relatorios.categoria-projetos', $categoria->id)}}"><i
                                        class="small material-icons">chrome_reader_mode</i></a>
                        </td>
                    </tr>
                @empty
